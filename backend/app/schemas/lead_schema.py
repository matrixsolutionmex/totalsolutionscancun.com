...
class ServiceOrderResponse(BaseModel):
    ...
    pricing_service_type: str | None = None
    pricing_segment: str | None = None
    pricing_zone: str | None = None
    visit_base_price: float | None = None
    travel_surcharge: float | None = None
    urgency_level: str | None = None
    urgency_multiplier: float | None = None
    visit_calculated_price: float | None = None
    market_reference_min: float | None = None
    market_reference_max: float | None = None
    customer_budget_min: float | None = None
    customer_budget_max: float | None = None
    final_service_price: float | None = None
    pricing_currency: str | None = None
    pricing_version: str | None = None
    visit_credit_policy: str | None = None
    pricing_distance_km: float | None = None
    pricing_duration_minutes: float | None = None
